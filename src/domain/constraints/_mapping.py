...
from domain.constraints.teacher_daily_lessons import TeacherDailyLessonsConstraint
from domain.constraints.teacher_consecutive_lessons import TeacherConsecutiveLessonsConstraint
...
CONSTRAINT_DEFINITIONS_BUILT_IN = {
    ...
    "TEACHER_DAILY_LESSONS": TeacherDailyLessonsConstraint,  # 教員の1日あたりのコマ数 → レビュー必要
    "TEACHER_CONSECUTIVE_LESSONS": TeacherConsecutiveLessonsConstraint,  # 教員の連続コマ数 → レビュー必要
